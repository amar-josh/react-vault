...
The user will specify scope. If they say "compliance audit", default to **RBI Annexure I** since this is the most common requirement for Your Org BFSI work. If they specify a different framework, switch.
...
| 4.x Encryption                      | Web Crypto usage                                           | `@scope/core/encryption` imports                  |
...
- `@scope/core/encryption` (AES-GCM 256) imported in src/storage/secureCache.ts.
