 ...
 *   - Regex patterns come from `@react-vault/core/pii` where applicable;
 *     project-specific patterns go in `src/constants/regex.ts` (add when
 *     you have your first one — don't pre-create empty files).
 */
import { z } from 'zod';
